...
public class LoggingAspect {
    ...
    public void setUp() {
        ...
        objectMapper.setFilterProvider(new SimpleFilterProvider().addFilter("ignoreFieldsFilter",
                SimpleBeanPropertyFilter.serializeAllExcept("password", "file", "inputStream", "outputStream", "reader",
                        "writer")));
        objectMapper.addMixIn(Object.class, IgnoreFieldsFilterMixin.class);
    }
